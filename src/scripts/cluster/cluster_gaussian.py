...
parser.add_argument("--arch", type=str, default="SimpleModel")
parser.add_argument("--opt", type=str, default="Adam")
parser.add_argument("--mode", type=str, default="IID")

parser.add_argument("--dataset", type=str, default="Gaussian_2D_test")
parser.add_argument("--dataset_root", type=str,
                    default="/home/hinnertr/MiS-Information-Clustering/Gaussian-2D/")
...
parser.add_argument("--out_root", type=str,
                    default="/home/hinnertr/MiS-Information-Clustering/out//")
